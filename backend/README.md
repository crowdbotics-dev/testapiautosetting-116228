...
## Project Structure
    ...
    ├── testapiautosetting_116228  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_116228`
...
2. Clone this repo and `cd testapiautosetting_116228`
